...
execute: 
  ...
  warning: false
editor: source
# **IMPORTANT**, need to run following command in the conda env to install TinyTeX
# curl -sL "https://yihui.org/tinytex/install-bin-unix.sh" | sh
# (for more information, pls visit: https://yihui.org/tinytex/)
---
...
Horse population data were sourced from the Government of Canada @horses2
...
We present the standard deviations in @tbl-horses_sc.
...
![Horse populations for the province with the largest standard deviation.](../results/horse_pops_plot_largest_sd.png){width="40%" #fig-horse_pops_plot_big_sd}

In @fig-horse_pops_plot_big_sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
